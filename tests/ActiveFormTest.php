...
class ActiveFormTest extends TestCase
{
    public function testDefaultLayout(): void
    {
        ...
        $form = ActiveForm::begin(['action' => '/some-action', 'layout' => ActiveForm::LAYOUT_DEFAULT]);
    ...
    public function testHorizontalLayout(): void
    {
        ...
        $form = ActiveForm::begin(['action' => '/some-action', 'layout' => ActiveForm::LAYOUT_HORIZONTAL]);
        echo $form->field($model, 'attributeName');
    ...
    public function testInlineLayout(): void
    {
        ...
        $form = ActiveForm::begin(['action' => '/some-action', 'layout' => ActiveForm::LAYOUT_INLINE]);
        echo $form->field($model, 'attributeName');
    ...
    public function testFloatingLayout(): void
    {
        ...
        ob_start();
        $model = new DynamicModel(['attributeName', 'selectName', 'checkboxName']);
        $form = ActiveForm::begin(['action' => '/some-action', 'layout' => ActiveForm::LAYOUT_FLOATING]);
        echo $form->field($model, 'attributeName');
        echo $form->field($model, 'selectName')->listBox([
            '1' => 'One',
            '2' => 'Two',
