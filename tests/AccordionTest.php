...
final class AccordionTest extends TestCase
{
    ...
    /**
     * @dataProvider \yiiunit\extensions\bootstrap5\providers\Data::invalidItems
     */
    ...
    public function testAutoCloseItems(): void
    {
        ...
        $output = Accordion::widget(['items' => $items]);
        $this->assertStringContainsString('data-bs-parent="', $output);

        $output = Accordion::widget(['autoCloseItems' => false, 'items' => $items]);
